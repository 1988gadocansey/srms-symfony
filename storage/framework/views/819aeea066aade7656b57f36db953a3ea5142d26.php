...
<div align="center">
    ...
    <h5 class="uk-text-upper"> Form settings for <?php echo e($data[0]->NAME); ?></h5>
    <hr>

    <form id='form' method="POST" action="<?php echo e(url('/admissions/applicant/fire')); ?>" accept-charset="utf-8"  name="applicationForm"  v-form>
                            ...
                            <tr>
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo e($data[0]->APPLICATION_NUMBER); ?>

                                                <input type="hidden" name="student" id="student" value="<?php echo e($data[0]->APPLICATION_NUMBER); ?>" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" name="name" id="name" value="<?php echo e($data[0]->NAME); ?>" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php echo e($sys->getProgram($data[0]->FIRST_CHOICE)); ?>
                                ...
                                <td valign="top">
                                    <img   style="width:150px;height: auto;"  <?php
                                           ...
                                           ?>   src="http://application.ttuportal.com/public/uploads/photos/<?php echo e($data[0]->APPLICATION_NUMBER); ?>.jpg" alt="  Affix student picture here"    />
                                </td>
                            </tr>
                        </table>
                    </div>
...
var applicant = $('#name').val();
        ...
        UIkit.modal.confirm("Are you sure of what you are about? "
                , function(){
                modal = UIkit.modal.blockUI("<div class='uk-text-center'>Executing action on " + applicant + "<br/><img class='uk-thumbnail uk-margin-top' src='<?php echo url('public/assets/img/spinners/spinner.gif'); ?>' /></div>");
                        //setTimeout(function(){ modal.hide() }, 500) })()            
                        $.ajax({

                        type: "POST",
                                url:"<?php echo e(url('/admissions/applicant/fire')); ?>",
