    ...
    <div class="header_main_content">
        <nav class="uk-navbar">
            <div class="main_logo_top">
                <a href="/dashboard"><img src='<?php echo e(url("public/assets/img/logo.png")); ?>' alt="" height="15" width="71"/></a>
    ...
    <div class="md-top-bar">
        ...
        <?php if(@Auth::user()->phone!=''): ?>
            ...
            <ul id="menu_top" class="uk-clearfix">
                <li class="uk-hidden-small"><a href='<?php echo url("/dashboard"); ?>'><i title='home'class="material-icons">&#xE88A;</i><span>Home</span></a></li>
                    ...
                    <li data-uk-dropdown class="uk-hidden-small">
                        ...
                        <div class="uk-dropdown uk-dropdown-scrollable">
                            <ul class="uk-nav uk-nav-dropdown">
                                ...
                                <li><a href='<?php echo url("admissions/statistics/comprehensive"); ?>'>Applied/Registered</a></li>

                                <li><a href='<?php echo url("/view_payments_master"); ?>'>Fee Payment by Students Report</a></li>
                                <li><a href='<?php echo url("/finance/reports/programs"); ?>'>Fee Payment by Programs Report</a></li>
                                <li><a href='<?php echo url("/owing_paid"); ?>'>Fees Owings By Students Reports</a></li>
                                <li><a href='<?php echo url("/finance/reports/programs"); ?>'>Fees Owings By Programs Reports</a></li>
                                <li><a href='<?php echo url("/finance/reports/ledger/student"); ?>'>Print Student Ledger</a></li>
                                <li><a href='<?php echo url("/finance/reports/cummulative"); ?>'>Fees Cummulative Reports by Program</a></li>
                ...
                <?php if( @Auth::user()->department=='Admissions' ): ?>
                    ...
                    <li data-uk-dropdown class="uk-hidden-small">
                        ...
                        <div class="uk-dropdown uk-dropdown-scrollable">
                            <ul class="uk-nav uk-nav-dropdown">
                                ...
                                <li><a href='<?php echo url("admissions/letter/bulk"); ?>'>Print bulk admission letters</a></li>
                    ...
                    <li data-uk-dropdown class="uk-hidden-small">
                        ...
                        <div class="uk-dropdown uk-dropdown-scrollable">
                            <ul class="uk-nav uk-nav-dropdown">
                                <li><a href='<?php echo url("/admissions/statistics/admission/type"); ?>'>Admission Type</a></li>
                                <li><a href='<?php echo url("admissions/statistics/comprehensive"); ?>'>Applied/Registered</a></li>
                                ...
                                <li><a href='<?php echo url("/results/technical"); ?>'>Accreditation Board Technical Results</a></li>
                                <li><a href='<?php echo url("/results/conditional"); ?>'>Accreditation Board Conditional Results</a></li>
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            ...
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href='<?php echo url("/print/receipt"); ?>'>Print Fee Receipt</a></li>
                                    <li><a href='<?php echo url("/print/password"); ?>'>Print Password Receipt</a></li>
                                    <li><a href='<?php echo url("/attendanceSheet"); ?>'>Print Exam Attendance Sheet</a></li>
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            ...
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href='<?php echo url("/finance/upload"); ?>'>Upload Students Fees Balance</a></li>
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            ...
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    <li><a href='<?php echo url("/report/registration"); ?>'>Registration</a></li>
                                    <li><a href='<?php echo url("admissions/statistics/comprehensive"); ?>'>Applied/Registered</a></li>
                                    <li><a href='<?php echo url("/admissions/statistics/admission/type"); ?>'>Report by Admission Type</a></li>
                                    <li><a href='<?php echo url("/broadsheet/noticeboard"); ?>'>GPA Academic Board</a></li>
                                    <li><a href='<?php echo url("/broadsheet/napbtex"); ?>'>Broadsheet Nabptex</a></li>
                        ...
                        <li data-uk-dropdown class="uk-hidden-small">
                            ...
                            <div class="uk-dropdown uk-dropdown-scrollable">
                                <ul class="uk-nav uk-nav-dropdown">
                                    ...
                                    <li><a href='<?php echo url("banks"); ?>'>View Banks</a></li>
                                    <li><a href='<?php echo url("view_payments"); ?>'>Payments Ledger</a></li>
                                    <li><a href='<?php echo url("view_payments"); ?>'>Transactions Ledger</a></li>
                                    <li><a href='<?php echo url("view_payments_master"); ?>'>Master Fee Payment Report</a></li>
                            ...
                            <li data-uk-dropdown class="uk-hidden-small">
                                ...
                                <div class="uk-dropdown uk-dropdown-scrollable">
                                    <ul class="uk-nav uk-nav-dropdown">
                                        ...
                                        <li><a href='<?php echo url("fee_summary"); ?>'>View Attachment Data</a></li>

                                        <li><a href='<?php echo url("fee_summary"); ?>'>Attachment Reports</a></li>
                                        <li><a href='<?php echo url("fee_summary"); ?>'>Close or open online system</a></li>
...
//console.log($(this).prop('name')+"->"+$('#paymentTable .pay_type  :selected').parent().length);
        ...
        $('#save').on('click', function(e) {
            return (function(modal){ modal = UIkit.modal.blockUI("<div class='uk-text-center'>Processing data<br/><img class='uk-thumbnail uk-margin-top' src='<?php echo url('public/assets/img/spinners/spinner_success.gif'); ?>' /></div>"); setTimeout(function(){ modal.hide() }, 50000) })();
        });
    });    </script>
<!-- google web fonts -->
<script>
