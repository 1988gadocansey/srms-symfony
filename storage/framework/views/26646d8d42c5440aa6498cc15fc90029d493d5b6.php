...
<div align="center">
    ...
    <form id='form' method="POST" action="<?php echo e(url('processPayment')); ?>" accept-charset="utf-8"  name="applicationForm"  v-form>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo Form::select('level',$level ,array("required"=>"required","class"=>"md-input","id"=>"level","v-model"=>"level","v-form-ctrl"=>"","v-select"=>"level")   ); ?>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php else: ?>
                                                    <input type="hidden" name="student" id="student" value="<?php echo e($data[0]->STNO); ?>" />
                        ...
                        <div class="uk-overflow-container" id='print'>
                            <table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter"> 
                                ...
                                <tbody>
                                    ...
                                    <?php foreach($finance as $index=> $row): ?> 


                                    <tr align="">
                                         
                                        <td> <?php echo e($finance->perPage()*($finance->currentPage()-1)+($index+1)); ?> </td>
                                        <td> <?php echo e(strtoupper($data[0]->NAME)); ?></td>

                                        <td> <?php echo e(strtoupper(@$row->LEVEL)); ?></td>
                                        <td> <?php echo e(@$row->YEAR); ?></td>
                                        <td> <?php echo e(@$row->SEMESTER); ?></td>
                                        <td>GHS<?php echo e(@$row->AMOUNT); ?></td>
                                        <td> <?php echo e(@$row->FEE_TYPE); ?></td>
                                        <td> <?php echo e(@$row->user->name); ?></td>
                                                       <td>
                                                  
                                                      <a onclick="return MM_openBrWindow('<?php echo e(url("printreceipt/" . trim(@$row->RECEIPTNO))); ?>', 'mark', 'width=800,height=500')" ><i title='Click to print receipt of this payment .. please allow popups on browser' class="md-icon material-icons">book</i></a> 
                           
                                                 <?php echo Form::open(['action' =>['FeeController@destroyPayment', 'id'=>$row->ID], 'method' => 'DELETE','name'=>'myform' ,'style' => 'display: inline;']); ?>
