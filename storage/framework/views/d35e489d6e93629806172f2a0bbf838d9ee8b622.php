...
<?php $__env->startSection('content'); ?>
    ...
    <div style="">
        <div class="uk-margin-bottom" style="margin-left:900px" >
            ...
            <a  href="<?php echo e(url('/report/sms')); ?>"  onclick="return confirm('This will send bulk grades score notification to all students')"  title="sent bulk admission notification to applicants"> <i   title="click to sent bulk admission notification to applicants"  class="material-icons md-36 uk-text-success"   >phonelink_ring</i></a>
            ...
            <div class="md-card-content">
                ...
                <form action="<?php echo e(url('process_broadsheet_napbtex')); ?>"  method="POST" accept-charset="utf-8"  >
                    ...
                    <div class="uk-grid" data-uk-grid-margin="">
                       ...
                       <?php /* <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
    ...
    <?php if(Request::isMethod('post')): ?>
        <p></p>
        <h4 class="heading_c uk-text-upper"><center>Broadsheet for <?php echo e($sys->getProgram($programs)); ?>    Level <?php echo e($levels); ?></center></h4>
        <p></p>
        <div class="uk-width-xLarge-1-1">
            <div class="md-card">
                <div class="md-card-content">
