                    ...
                    <div class="uk-grid" data-uk-grid-margin="">
                        ...
                        <div class="uk-width-medium-1-5">
                            <div class="uk-margin-small-top">
                                ...
                                <?php echo Form::select('status', array('Admitted'=>'Admitted','In School'=>'In school','Alumni' => 'Completed','Deferred' => 'Deferred','Dead' => 'Dead','Rusticated' => 'Rusticated','Unknown' => 'Unknown'), null, ['placeholder' => 'select status of student','id'=>'parent','class'=>'md-input parent'],old("level",""));; ?>
                ...
                <div class="uk-overflow-container" id='print'>
                    ...
                    <table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair"
                        ...
                        <tr>
                            ...
                            <?php if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->department=="Tptop" || @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant"  || @\Auth::user()->department == 'top'): ?>
                                <th>PHONE</th>
                            <?php endif; ?>
                            <th>NATIONALITY</th>
                            <th>YEAR BILLS</th>
                            <?php if(@\Auth::user()->role=='Dean' || @\Auth::user()->department=="Tpmid" || @\Auth::user()->department=="Tptop" || @\Auth::user()->department=="Finance" || @\Auth::user()->department=="Rector" || @\Auth::user()->role=="Rector" || @\Auth::user()->role=="Accountant"  || @\Auth::user()->department == 'top'): ?>
                                <th>OWINGS</th>
                                <th>PASSWORD</th>
                            <?php endif; ?>
                            <th>YEAR GROUP</th>
                            ...
                            <tr align="">
                                ...
                                <td>
                                    ...
                                    <?php if(substr($row->LEVEL, 0, 3 ) === "100" || substr($row->LEVEL, 0, 3 ) === "500"  ): ?>
                                        ...
                                        ?>  src="http://application.ttuportal.com/public/uploads/photos/<?php echo e($pic); ?>.jpg"
                                             alt="photo"/>
                                    ...
                                    <?php else: ?>
                                        <img style="width:165px;height:auto;margin-left:-5px"
                                             <?php echo $sys->picture('<?php echo e(url("public/albums/students/$row->INDEXNO")); ?>',210); ?> src='<?php echo e(url("public/albums/students/$row->INDEXNO".'.JPG')); ?>'
