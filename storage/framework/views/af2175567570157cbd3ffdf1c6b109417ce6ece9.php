   ...
   <?php $sys = app('App\Http\Controllers\SystemController'); ?>
         ...
         <div class="uk-grid uk-grid-width-large-1-4 uk-grid-width-medium-1-2 uk-grid-medium uk-sortable ">
            ...
            <div class="uk-grid uk-grid-width-small-1-2 uk-grid-width-large-1-3 uk-grid-width-xlarge-1-5 uk-text-center uk-sortable sortable-handler" id="dashboard_sortable_cards" data-uk-sortable data-uk-grid-margin>
              <?php if(@Auth::user()->department=='Planning' || @Auth::user()->role=='HOD' || @Auth::user()->department=='top' || @Auth::user()->department=='Rector'): ?>        
                <div>
                ...
                <div>
                 ...
                 <?php endif; ?>
                 <?php if( @Auth::user()->department=='top' ||  @Auth::user()->role=='HOD' || @Auth::user()->department=='Rector' || @Auth::user()->department=='Tpmid' || @Auth::user()->department=='Tptop' || @Auth::user()->role=='Support' || @Auth::user()->department=='Planning'): ?>
                
                <div>
                    <div class="md-card md-card-hover md-card-overlay">
                        <div class="md-card-content">
                            <a  href='<?php echo e(url("/broadsheet/napbtex")); ?>'>  <img src="<?php echo e(url('public/assets/img/dashboard/nabptex.png')); ?>"/></a>
                        </div>
                        <div class="md-card-overlay-content uk-badge-success">
                            <div class="uk-clearfix md-card-overlay-header">
                                <i class="md-icon material-icons md-card-overlay-toggler">&#xE5D4;</i>
