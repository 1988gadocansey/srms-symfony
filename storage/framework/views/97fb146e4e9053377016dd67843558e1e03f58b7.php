...
echo $obj->picture("{!! url(\"public/albums/students/$pic.jpg\") !!}", 90) ?>   src="<?php echo url("public/albums/students/$pic.jpg") ?>" alt=" Picture of Student Here"    /></a> 
            ...
            <input type="hidden" name="id" value="<?php echo e($data->ID); ?>">
                ...
                <div data-uk-observe="" id="wizard_advanced" role="application" class="wizard clearfix">
                    ...
                    <div class=" clearfix " style="box-sizing: border-box;display: block;padding:15px!important;position: relative;">
                        ...
                        <!-- first section -->
                        <?php /* <h3 id="wizard_advanced-h-0" tabindex="-1" class="title current">Fill Form</h3> */ ?>
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('title',array("Mr"=>"Mr","Mrs"=>"Mrs","Miss"=>"Miss"),old('title',$data->TITLE),array('placeholder'=>'Select title',"required"=>"required","class"=>"md-input","v-model"=>"title","v-form-ctrl"=>"","v-select"=>"title")); ?>
                             ...
                             <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('gender',array("Male"=>"Male",'Female'=>"Female"),old('gender',''),array('placeholder'=>'Select gender',"required"=>"required","class"=>"md-input","v-model"=>"gender","v-form-ctrl"=>"","v-select"=>"gender")); ?>
                                ...
                                <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('marital_status',array("Married"=>"Married",'Single'=>"Single"),old('marital_status',''),array('placeholder'=>'Select marital status',"required"=>"required","class"=>"md-input","v-model"=>"marital_status","v-form-ctrl"=>"","v-select"=>"marital_status")); ?>
               ...
               <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                                ...
                                <div class="parsley-row"  >
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                          <?php echo Form::select('religion', (['' => 'select religion'] + $religion ),old('religion',$data->RELIGION),array("required"=>"required","class"=>"md-input","id"=>"religion","v-model"=>"religion","v-form-ctrl"=>"","style"=>"","v-select"=>"religion")   ); ?>
                            ...
                            <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                               ...
                               <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('region',$region ,old('region',$data->REGION),array("required"=>"required","class"=>"md-input","id"=>"region","v-model"=>"region","v-form-ctrl"=>"","v-select"=>"<?php echo e(old('region')); ?>")   ); ?>
                                 ...
                                 <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                             <?php echo Form::select('nationality',$country ,old('nationality',$data->COUNTRY),array("required"=>"required","class"=>"md-input","id"=>"nationality","v-model"=>"nationality","v-form-ctrl"=>"","v-select"=>"nationality")   ); ?>
                                  ...
                                  <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('category',array("Regular"=>"Regular","Evening"=>"Evening","Weekend"=>"Weekend",'Exchange programme'=>'Exchange programme'),old('category',$data->TYPE),array('placeholder'=>'Select category',"required"=>"required","class"=>"md-input","v-model"=>"category","v-form-ctrl"=>"","v-select"=>"category")); ?>
                              ...
                              <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                              <?php echo Form::select('year',$level ,old("year",$level),array("required"=>"required","class"=>"md-input","id"=>"year","v-model"=>"year","v-form-ctrl"=>"","v-select"=>"year")   ); ?>
                                ...
                                <div class="parsley-row" style="margin-left:10px">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                             <?php echo Form::select('programme', (['' => 'Select programs'] + $programme ),old('programme',$programme),array("required"=>"required","class"=>"md-input","id"=>"programme","v-model"=>"programme","v-form-ctrl"=>"","v-select"=>"programme")   ); ?>
                                  ...
                                  <div class="parsley-row" style="margin-left:80px">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('type',array("Resident"=>"Resident",'Non Resident'=>"Non Resident"),old('type',$data->TYPE),array('placeholder'=>'Select residential status', "style"=>"","class"=>"md-input","v-model"=>"type","v-form-ctrl"=>"","v-select"=>"type")); ?>
                                ...
                                <div class="parsley-row" v-if ="type=='Resident'">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                          <?php echo Form::select('halls',$hall,array("required"=>"required","class"=>"md-input","id"=>"halls","v-model"=>"halls","v-form-ctrl"=>"","style"=>"width: 226px;","v-select"=>"halls")   ); ?>
      ...
      <!-- second section -->
      <?php /* <h3 id="payment-heading-1" tabindex="-1" class="title">Payment</h3> */ ?>
                                ...
                                <div class="parsley-row">
                                  ...
                                  <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('disable',array('Disabled'=>'Disabled','None' => 'None'),old('year',''),array('placeholder'=>'Select response',"class"=>"md-input","v-model"=>"disable","v-form-ctrl"=>"","v-select"=>"disable")); ?>
              ...
              <div data-uk-grid-margin="" class="uk-grid uk-grid-width-medium-1-4 uk-grid-width-large-1-4">
                   ...
                   <div class="parsley-row">
                                    <div class="uk-input-group">
                                        ...
                                        <div class="md-input-wrapper md-input-filled">
                                            <?php echo Form::select('status',array("In School"=>"In School","Alumni"=>"Alumni",'Deferred'=>'Deferred','Rusticated'=>'Rusticated','Dead'=>'Dead'),old('category',''),array('placeholder'=>'Select category', "class"=>"md-input","v-model"=>"category","v-form-ctrl"=>"","v-select"=>"category")); ?>
...
var vm = new Vue({
 ...
 data : {
  fname : "<?php echo e($data->FIRSTNAME); ?>",
  surname : "<?php echo e($data->SURNAME); ?>",
  othernames : "<?php echo e($data->OTHERNAMES); ?>",
  gender : "<?php echo e($data->SEX); ?>",
  marital_status: "<?php echo e($data->MARITAL_STATUS); ?>",
  address: "<?php echo e($data->ADDRESS); ?>",
  contact: "<?php echo e($data->RESIDENTIAL_ADDRESS); ?>",
   phone : "<?php echo e($data->TELEPHONENO); ?>",
    title : "<?php echo e($data->TITLE); ?>",
    nhis : "<?php echo e($data->NHIS); ?>",
    indexno : "<?php echo e($data->INDEXNO); ?>",
    email : "<?php echo e($data->EMAIL); ?>",
    region : "<?php echo e($data->REGION); ?>",
    religion : "<?php echo e($data->RELIGION); ?>",
    dob : "<?php echo e($data->DATEOFBIRTH); ?>",

     hometown : "<?php echo e($data->HOMETOWN); ?>",
    programme : "<?php echo e($data->PROGRAMMECODE); ?>",
    country : "<?php echo e($data->COUNTRY); ?>",
    disability : "<?php echo e($data->DISABILITY); ?>",
    gname : "<?php echo e($data->GUARDIAN_NAME); ?>",
    gaddress: "<?php echo e($data->GUARDIAN_ADDRESS); ?>",
    gphone : "<?php echo e($data->GUARDIAN_PHONE); ?>",
    goccupation : "<?php echo e($data->GUARDIAN_OCCUPATION); ?>",
    hostel : "<?php echo e($data->HOSTEL); ?>",
    residential : "<?php echo e($data->STUDENT_TYPE); ?>",
    category : "<?php echo e($data->TYPE); ?>",
    halls : "<?php echo e($data->HALL); ?>",
 ...
 options: [      
  ...
  methods : {
    ...
    submit_form : function(){
      return (function(modal){ modal = UIkit.modal.blockUI("<div class='uk-text-center'>Saving Data<br/><img class='uk-thumbnail uk-margin-top' src='<?php echo url('assets/img/spinners/spinner_success.gif'); ?>' /></div>"); setTimeout(function(){ modal.hide() }, 50000) })();
    },
