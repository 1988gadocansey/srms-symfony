<style>
  ...
  size: A4;
    ...
    body{
        background-image:url("<?php echo e(url('public/assets/img/background.jpgs')); ?>");
    ...
    <div class="row">
        ...
        <div id='print'>
            <div id='page1'>
                        <table border='0'>
                            <tr>
                                <td> <img  style="width:767px;height: auto" src='<?php echo e(url("public/assets/img/header.jpg")); ?>' style=""  class="image-responsive"/> 
                                ...
                                <p>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</p>
                                      <img   style="width:106px;height: 134px;margin-left: -3px;    margin-top: -34px; "  <?php
                                        ...
                                        ?>  src="http://application.ttuportal.com/public/uploads/photos/<?php echo e($data->APPLICATION_NUMBER); ?>.jpg"alt="photo"     />
                        ...
                        <div class="content" id="technical">  <div class="watermark">
                             <div style="margin-left: 10px">
                                 <p style="text-transform: capitalize">DEAR <span style="text-transform: capitalize"> <?php echo e($data->TITLE); ?>.  <?php echo e($data->NAME); ?></span></p>
                           
                            <div style="margin-left: 0px;text-align: justify">
                               
                                <centerd><b><p class="">OFFER OF ADMISSION  - <?php echo e(strtoupper(@$data->admitedProgram->department->schools->FACULTY)); ?>  -  ADMISSION N<u>O </u>: <?php echo e($data->APPLICATION_NUMBER); ?></p></b></center>
                                <hr>
                       ...
                       <?php if(0===strpos($data->PROGRAMME_ADMITTED,'B')): ?>
                                   <?php elseif(0===strpos($data->PROGRAMME_ADMITTED,'C') || 0===strpos($data->PROGRAMME_ADMITTED,'A')): ?>
                                    
                                      <?php elseif(0===strpos($data->PROGRAMME_ADMITTED,'H')): ?>
                                    
                                       <?php elseif(0===strpos($data->PROGRAMME_ADMITTED,'D')): ?>
                                        
                                      <?php else: ?>
                                      <?php endif; ?><b> <?php echo e($sys->getProgram($data->PROGRAMME_ADMITTED)); ?></b>. The duration of the programme is <?php echo e($sys->getProgramDuration($data->PROGRAMME_ADMITTED)); ?> Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                ...
                                <p>1. Your admission is for the<b> <?php echo e($year); ?> </b>Academic year. If you fail to enroll or withdraw from the programme without prior approval of the University, you will forfeits the admission automatically.</p>
                              
                                <p>2. The<b> <?php echo e($year); ?> academic year</b> is scheduled to begin on <b> Monday 28th August   <?php echo e(date('Y')); ?></b>. You are expected to report for medical examination and registration from <b>Monday 28th August <?php echo e(date('Y')); ?> to Friday 8th September  <?php echo e(date('Y')); ?></b>.You are mandated to participate in orientation programme which will run from <b>Monday 4th September to Friday 8th September <?php echo e(date('Y')); ?></b>.</p>
                                
                                 <p>3. You are required to make <b>PROVISIONAL PAYMENT</b> of <b>GHS<?php echo e($data->ADMISSION_FEES); ?></b> at any branch of
                               
                                  <?php if($data->admitedProgram->TYPE=="NON TERTIARY"): ?>
                                     <b> UNIBANK into Account Number   1570105703613</b>. If you do not indicate acceptance by paying the fees before <b> Monday 28th August,<?php echo e(date('Y')); ?></b> your place will be offered to another applicant on the waiting list. You are advised to make photocopy of the Pay-in-slip for keeps and present the original to the School Accounts Office on arrival.Indicate your admission number and programme of study on the Pay-in-slip. Any Applicant who fails to make <b>PROVISIONAL PAYMENT</b> of fees forfeits his/her admission. <b>Note: Fee payment is for an Academic Year and non-refundable</b>.</p>
                                 ...
                                 <?php else: ?>
                                        <b><?php echo e(strtoupper(@$data->admitedProgram->department->schools->banks->NAME)); ?> into Account Number <?php echo e(@$data->admitedProgram->department->schools->banks->ACCOUNT_NUMBER); ?></b>. If you do not indicate acceptance by paying the fees before <b> Monday 28th August,<?php echo e(date('Y')); ?></b> your place will be offered to another applicant on the waiting list. You are advised to make photocopy of the Pay-in-slip for keeps and present the original to the School Accounts Office on arrival.Indicate your admission number and programme of study on the Pay-in-slip. Any Applicant who fails to make <b>PROVISIONAL PAYMENT</b> of fees forfeits his/her admission. <b>Note: Fee payment is for an Academic Year and non-refundable</b>.</p>
                          ...
                          <?php if($data->RESIDENTIAL_STATUS==0): ?> 
                            <p>10. You are affiliated to<b> <?php echo e(strtoupper($data->HALL_ADMITTED)); ?> Hall. </b></p>
                          
                           <?php else: ?>
                           <p>10. You have been given Hall Accommodation at<b> <?php echo e(strtoupper($data->HALL_ADMITTED)); ?> Hall </b>. You will be required to make payment of  GHS<?php echo e($sys->hallFees($data->HALL_ADMITTED)); ?> into any branch of Zenith Bank Ghana with account number  <?php echo e($sys->hallAccount($data->HALL_ADMITTED)); ?>. <b/>You shall report to your assigned hall of residence with the original copy of pay-in-slip
                           NOTE: Hall fees paid is not refundable.
                            ...
                            <p>You are required to make <b>PROVISIONAL PAYMENT</b> of all fees before or on Monday 28th August <?php echo e(date('Y')); ?>. </p>
                           ...
                           <td>
                               ...
                               <p><img src='<?php echo e(url("public/assets/img/signature.png")); ?>' style="width:90px;height:auto;" /></p>
                            ...
                            <td> <img src='<?php echo e(url("public/assets/img/footer.jpg")); ?>' style=""  class="image-responsive"/> 
                        ...
                        <div class="content" id="provisional">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <centerd><b><p class="">OFFER OF ADMISSION(<b>PROVISONAL</b>)  - <?php echo e(strtoupper(@$data->admitedProgram->department->schools->FACULTY)); ?>  -  ADMISSION N<u>O </u>: <?php echo e($data->APPLICATION_NUMBER); ?></p></b></center>
                                <hr>
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of 
                        ...
                        <div class="content" id="conditional">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                                ...
                                <centerd><b><p class="">OFFER OF ADMISSION(<b>CONDITIONAL</b>) - <?php echo e(strtoupper(@$data->admitedProgram->department->schools->FACULTY)); ?>  -  ADMISSION N<u>O </u>: <?php echo e($data->APPLICATION_NUMBER); ?></p></b></center>
                                <hr>
                        ...
                        <div class="content" id="regular">  <div class="watermark">
                            ...
                            <div style="margin-left: 0px;text-align: justify">
                               <centerd><b><p class="">OFFER OF ADMISSION  -
                                            <?php if(@$data->admitedProgram->AFFILAITION==""): ?>
                                            <?php echo e(strtoupper(@$data->admitedProgram->department->schools->FACULTY)); ?>  -  
                                            <?php else: ?>
                                             <?php echo e(strtoupper(@$data->admitedProgram->PROGRAMME ."-".@$data->admitedProgram->AFFILAITION)); ?>  ADMISSION N<u>O </u>: <?php echo e($data->APPLICATION_NUMBER); ?></p></b></center>
                                <?php endif; ?>
                                            <hr>
                                <p>We write on behalf of the Academic Board to offer you admission to Takoradi  Technical University to pursue a programme of study leading to the award of
                                   ...
                                   <?php elseif(0===strpos($data->PROGRAMME_ADMITTED,'C') || 0===strpos($data->PROGRAMME_ADMITTED,'A')): ?>
                                      ...
                                      <?php else: ?>
                                      <?php endif; ?>
                                    <b> <?php echo e($sys->getProgram($data->PROGRAMME_ADMITTED)); ?></b>. The duration of the programme is <?php echo e($sys->getProgramDuration($data->PROGRAMME_ADMITTED)); ?> Academic years. A change of Programme is <strong><b>NOT ALLOWED</b>.</strong></p>
                                ...
                                <p>2. The<b> <?php echo e($year); ?> academic year</b> is scheduled to begin on <b> Monday 28th August   <?php echo e(date('Y')); ?></b>. You are expected to report for medical examination and registration from <b>Monday 28th August <?php echo e(date('Y')); ?> to Friday 8th September  <?php echo e(date('Y')); ?></b>.You are mandated to participate in orientation programme which will run from <b>Monday 4th September to Friday 8th September <?php echo e(date('Y')); ?></b>.</p>
                                 ...
                                 <p>3. You are required to make <b>PROVISIONAL PAYMENT</b>
                                     of <b>GHS<?php echo e($data->ADMISSION_FEES); ?></b> at any branch of 
                                     <?php if($data->admitedProgram->TYPE=="NON TERTIARY"): ?>
                                     <b> UNIBANK into Account Number   1570105703613</b>. If you do not indicate acceptance by paying the fees before <b> Monday 28th August,<?php echo e(date('Y')); ?></b> your place will be offered to another applicant on the waiting list. You are advised to make photocopy of the Pay-in-slip for keeps and present the original to the School Accounts Office on arrival.Indicate your admission number and programme of study on the Pay-in-slip. Any Applicant who fails to make <b>PROVISIONAL PAYMENT</b> of fees forfeits his/her admission. <b>Note: Fee payment is for an Academic Year and non-refundable</b>.</p>
