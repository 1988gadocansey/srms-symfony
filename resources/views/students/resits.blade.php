...
@section('content')
    ...
    @if(Request::isMethod('post'))
        <p></p>
        <h4 class="heading_c uk-text-upper"><center>Resit for {{$sys->getProgram($programs) }}, {{$years}} Academic year, Semester {{$term}}, Level {{$levels}}</center></h4>
        <p></p>
        <div class="uk-width-xLarge-1-1">
            <div class="md-card">
                <div class="md-card-content">
                    <div class="uk-overflow-container" id='print'>
                        ...
                        <table border='1' class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                            ...
                            <tr>
                                ...
                                <th COLSPAN="0" class="uk uk-text-bold" style="text-align:center;font-weight: bold">Level</th>
                            ...
                            <tr>
                                ...
                                <td> {{  @$strCtrl->getTrails(@$row->indexno,$term,$levels,$programs,$years)	 }}</td>
                        ...
                        <table border="1" class="uk-table">
                            ...
                            @foreach(array_unique($code) as  $key)
                                ...
                                <tr>
                                    ...
                                    <td>{{@$strCtrl->countTrails($key,$term,$levels,$programs,$years)}}</td>
