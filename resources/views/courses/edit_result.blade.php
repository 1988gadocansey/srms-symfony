                    ...
                    <table class="uk-table uk-table-hover uk-table-align-vertical uk-table-nowrap tablesorter tablesorter-altair" id="ts_pager_filter">
                        ...
                        ?>
                            ...
                            <tr align="">
                                ...
                                <td> {{ @$row->year }}</td>
                                <td>
                                    <a onclick="return MM_openBrWindow('{{url("enter_mark/$row->code/course/$row->code/code/year/$year/sem/$row->sem")}}','mark','width=800,height=500')" ><i title='Click to enter mark' class="md-icon material-icons">edit</i>View/Enter Marks</a>
