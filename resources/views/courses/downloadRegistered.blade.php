...
@section('content')
    <div class="md-card-content">
        ...
        @endif
        <h3 class="heading_c uk-margin-bottom">Download Registered Students</h3>
                ...
                <div class="md-card-content" style="">
                    ...
                    <form  action="{{url('/download_registered')}}" enctype="multipart/form-data" id="form" accept-charset="utf-8" method="POST" name="applicationForm"  v-form>
                        ...
                        <table align="center">
                            ...
                            <tr><td><input type="submit" value="Download Students" id='saves'   class="md-btn   md-btn-success uk-margin-small-top">
