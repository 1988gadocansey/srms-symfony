...
class SystemController extends Controller
{
    ...
    */
    ...
    public function checkTrails($indexno)
    {
        ...
        $subjectArray=array();
        $query = @Models\AcademicRecordsModel::where("indexno", $indexno)->where("grade","E")
            ->get();
        ...
        foreach ($query as $value) {
            ...
            @$subjects[] = @$value->code . "=" . @$value->grade;
            ...
            //$total = $this->CountFails($subjects);
